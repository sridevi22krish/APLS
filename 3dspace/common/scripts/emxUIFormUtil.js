...
function isValidUNSPSCCode(fieldObj) {
    if(fieldObj == null || fieldObj == "undefined" || fieldObj == "null" || fieldObj == "")
    {
    	fieldObj = this;
    }

       if( ! (fieldObj.value.length == 8 && isNumericForAT(fieldObj.value) ) )
       {
         alert("UNSPSC Code length should be 8 and must contain only numerical value.");
         return false;
       }
        return true;
}
...
function legth40Restriction(fieldObj) {
	if(fieldObj == null || fieldObj == "undefined" || fieldObj == "null" || fieldObj == "")
	{
		fieldObj = this;
	}
	...
	if(textLength>40){
		alert("Title Field exceeds maximum length of 40");
		return false;
	} else 
		return true;
}
